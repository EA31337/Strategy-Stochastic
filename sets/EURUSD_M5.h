...
struct Stg_Stochastic_EURUSD_M5_Params : Stg_Stochastic_Params {
  Stg_Stochastic_EURUSD_M5_Params() {
    symbol = "EURUSD";
    tf = PERIOD_M5;
    Stochastic_Period = 2;
    ...
    Stochastic_SignalBaseMethod = -61;
    Stochastic_SignalOpenMethod1 = 1;
