...
class Stg_Stochastic : public Strategy {
 public:
  ...
  static Stg_Stochastic *Init_M1() {
    ChartParams cparams1(PERIOD_M1);
    IndicatorParams stoch_iparams(10, INDI_STOCHASTIC);
    Stoch_Params stoch1_iparams(Stochastic_KPeriod, Stochastic_DPeriod, Stochastic_Slowing, Stochastic_MA_Method,
                                Stochastic_Price_Field);
    StgParams stoch1_sparams(new Trade(PERIOD_M1, _Symbol),
                             new Indi_Stochastic(stoch1_iparams, stoch_iparams, cparams1), NULL, NULL);
    stoch1_sparams.SetSignals(Stochastic1_SignalMethod, Stochastic1_OpenCondition1, Stochastic1_OpenCondition2,
                              Stochastic1_CloseCondition, NULL, Stochastic_SignalLevel, NULL);
    ...
    return (new Stg_Stochastic(stoch1_sparams, "Stochastic1"));
  }
  static Stg_Stochastic *Init_M5() {
    ChartParams cparams5(PERIOD_M5);
    IndicatorParams stoch_iparams(10, INDI_STOCHASTIC);
    Stoch_Params stoch5_iparams(Stochastic_KPeriod, Stochastic_DPeriod, Stochastic_Slowing, Stochastic_MA_Method,
                                Stochastic_Price_Field);
    StgParams stoch5_sparams(new Trade(PERIOD_M5, _Symbol),
                             new Indi_Stochastic(stoch5_iparams, stoch_iparams, cparams5), NULL, NULL);
    stoch5_sparams.SetSignals(Stochastic5_SignalMethod, Stochastic5_OpenCondition1, Stochastic5_OpenCondition2,
                              Stochastic5_CloseCondition, NULL, Stochastic_SignalLevel, NULL);
    ...
    return (new Stg_Stochastic(stoch5_sparams, "Stochastic5"));
  }
  static Stg_Stochastic *Init_M15() {
    ChartParams cparams15(PERIOD_M15);
    IndicatorParams stoch_iparams(10, INDI_STOCHASTIC);
    Stoch_Params stoch15_iparams(Stochastic_KPeriod, Stochastic_DPeriod, Stochastic_Slowing, Stochastic_MA_Method,
                                 Stochastic_Price_Field);
    StgParams stoch15_sparams(new Trade(PERIOD_M15, _Symbol),
                              new Indi_Stochastic(stoch15_iparams, stoch_iparams, cparams15), NULL, NULL);
    stoch15_sparams.SetSignals(Stochastic15_SignalMethod, Stochastic15_OpenCondition1, Stochastic15_OpenCondition2,
                               Stochastic15_CloseCondition, NULL, Stochastic_SignalLevel, NULL);
    ...
    return (new Stg_Stochastic(stoch15_sparams, "Stochastic15"));
  }
  static Stg_Stochastic *Init_M30() {
    ChartParams cparams30(PERIOD_M30);
    IndicatorParams stoch_iparams(10, INDI_STOCHASTIC);
    Stoch_Params stoch30_iparams(Stochastic_KPeriod, Stochastic_DPeriod, Stochastic_Slowing, Stochastic_MA_Method,
                                 Stochastic_Price_Field);
    StgParams stoch30_sparams(new Trade(PERIOD_M30, _Symbol),
                              new Indi_Stochastic(stoch30_iparams, stoch_iparams, cparams30), NULL, NULL);
    stoch30_sparams.SetSignals(Stochastic30_SignalMethod, Stochastic30_OpenCondition1, Stochastic30_OpenCondition2,
                               Stochastic30_CloseCondition, NULL, Stochastic_SignalLevel, NULL);
    ...
    return (new Stg_Stochastic(stoch30_sparams, "Stochastic30"));
  }
  static Stg_Stochastic *Init(ENUM_TIMEFRAMES _tf) {
    switch (_tf) {
      case PERIOD_M1:
        return Init_M1();
      case PERIOD_M5:
